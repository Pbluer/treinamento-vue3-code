    ...
    <div class="header-group">
      <div class="flex items-center justify-between py-10">
        <div class="w-28 lg:w-36">
          <img class="w-full" src="../../assets/image/logo_white.svg" alt="logo">
        </div>
        <div class="flex">
          <button @click="() => emit('createAccount')" class="px-6 py-2 font-bold rounded-full text-white focus:outline-none">
            Crie uma conta
          </button>
          <button
          @click="() => emit('login')"
...
<style lang="postcss" scoped>
  ...
  @media (min-width:640px){
    .header-group{
      background-image: url('../../assets/image/blue-balloon.svg');
